                    ...
                    switch (AddExSubject.valueOf(passedArg)) {
                        case ADD_BASIC:
                            ...
                            if (!exercise.contains("+")) { // Check that the exercise contains "+"
                                ...
                                alertDialogBuilder.setMessage(WRONG_EX_MSG_PROP).setCancelable(false).setPositiveButton(PropertiesUtil.getOkMessage(), new DialogInterface.OnClickListener() {
                                ...
                                // Check that the exercise sum isn't less than 0 or more than 10
                                    ...
                                    alertDialogBuilder.setMessage(NOT_MATCHING_EX_MSG_PROP).setCancelable(false).setPositiveButton(PropertiesUtil.getOkMessage(), new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int id) {
                                            dialog.cancel();
                                        }
                                    });
                                    ...
                                    ref.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(DataSnapshot snapShot) {
                                            ...
                                            for (int i = 1; i <= childrenCount; i++) {
                                                ...
                                                if (snapShot.child(childNum).child(Constants.QUESTION).getValue().equals(exercise)) {
                                                    found = true;
                                                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                                                            context);
                                                    alertDialogBuilder.setTitle(EX_EXISTS_TITLE_PROP);
                                                    try {
                                                        alertDialogBuilder.setMessage(EX_EXISTS_MSG_PROP).setCancelable(false).setPositiveButton(PropertiesUtil.getOkMessage(), new DialogInterface.OnClickListener() {
                                                            public void onClick(DialogInterface dialog, int id) {
                                                                dialog.cancel();
                                                            }
                                                        });
                                            ...
                                            if (!found) {
                                                ...
                                                newRef.child(Constants.QUESTION).setValue(exercise);
                                                ...
                                                try {
                                                    alertDialogBuilder.setMessage(ADDED_EX_MSG_PROP).setCancelable(false).setPositiveButton(PropertiesUtil.getOkMessage(), new DialogInterface.OnClickListener() {
                                                        public void onClick(DialogInterface dialog, int id) {
                                                            dialog.cancel();
                                                        }
                                                    });
