	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		learning.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				myIntent = new Intent(MenuActivity.this, com.easymath.activities.learn.LearningActivity.class);
		...
		help.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent myIntent= null;
				myIntent = new Intent(MenuActivity.this, com.easymath.activities.HelpActivity.class);
				MenuActivity.this.startActivity(myIntent);
		...
		training.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent myIntent= null;
				myIntent = new Intent(MenuActivity.this, com.easymath.activities.train.TrainingActivity.class);
				MenuActivity.this.startActivity(myIntent);
			}
		});
		...
		profile.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent myIntent= null;
				myIntent = new Intent(MenuActivity.this, com.easymath.activities.ProfileActivity.class);
				myIntent.putExtra("arg",  getText());
				MenuActivity.this.startActivity(myIntent);
			}
		});
		...
		test.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent myIntent= null;
				myIntent = new Intent(MenuActivity.this, com.easymath.activities.test.TestActivity.class);
				MenuActivity.this.startActivity(myIntent);
			}
		});
