		...
		switch (Action.valueOf(passedArg)) {
			...
			case ADD_EX:
				...
				basic.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						nextArg = "ADD_BASIC";
						Intent myIntent = new Intent(DifficultyActivity.this, com.easymath.activities.AddExScreenActivity.class);
	...
	public void prepareQuestions(String nextArg) {
		...
		ref.addListenerForSingleValueEvent(new ValueEventListener() {
			...
			public void onDataChange(DataSnapshot snapshot) {
				...
				myIntent = new Intent(DifficultyActivity.this, com.easymath.activities.train.TrainScreenActivity.class);
				DifficultyActivity.this.startActivity(myIntent);
				finish();
			}
			@Override
