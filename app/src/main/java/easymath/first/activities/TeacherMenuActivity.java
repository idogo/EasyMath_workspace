	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addEx.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				myIntent = new Intent(TeacherMenuActivity.this, easymath.first.activities.learn.LearningActivity.class);
		...
		help.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent myIntent= null;
				myIntent = new Intent(TeacherMenuActivity.this, easymath.first.activities.HelpActivity.class);
				TeacherMenuActivity.this.startActivity(myIntent);
			}
		});
		...
		connectStud.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent myIntent= null;
				myIntent = new Intent(TeacherMenuActivity.this, easymath.first.activities.ConnectStudentsActivity.class);
				TeacherMenuActivity.this.startActivity(myIntent);
			}
		});
		...
		public void onClick(View v) {
			...
			Intent myIntent= null;
			myIntent = new Intent(TeacherMenuActivity.this, easymath.first.activities.ManageStudentsActivity.class);
			TeacherMenuActivity.this.startActivity(myIntent);
		}
		});
	}
