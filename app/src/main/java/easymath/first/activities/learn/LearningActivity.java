package easymath.first.activities.learn;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		add.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				myIntent = new Intent(LearningActivity.this, easymath.first.activities.DifficultyActivity.class);
			...
			public void onClick(View v) {
				...
				switch (Subject.valueOf(passedArg)) {
					...
					case ADD_EX : 
						...
						nextArg= "ADDSUB";
						myIntent = new Intent(LearningActivity.this, easymath.first.activities.AddExScreenActivity.class);
